...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕MR SK▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕MR SK▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
...
\033[1;92m☞ WhatsApp   : +8801751019336
\033[1;95m☞ Facebook    : @M182B.SADHON
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Hunter_Sadhon Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' Hunter_Sadhon WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('cd $HOME && git clone https://github.com/M182B.SADHON')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
